...
SRC:=$(GOPATH)/src/github.com/sancfc/reporter
...
.PHONY: buildlinux
buildlinux:
	cmd //v //c "set GOOS=linux&&go install -v github.com/sancfc/reporter/cmd/grafana-reporter"
...
.PHONY: docker-build
docker-build:
	@docker build -t sancfc/grafana-reporter:2.3.0 -t sancfc/grafana-reporter:latest .

docker-push:
	@docker push sancfc/grafana-reporter
